            ...
            <div className="bg-white py-6 sm:py-8 lg:py-12">
                <div className="max-w-screen-lg px-4 md:px-8 mx-auto">
                    ...
                    <div>
                        ...
                        <div className="w-3/5 bg-gray-100 overflow-hidden rounded-lg shadow-lg relative mb-6 md:mb-8">
...

                        {
                            ...
                            <>
                                ...
                                <ul className="list-disc list-inside text-gray-500 sm:text-lg mb-6 md:mb-8">
                                    {
                                        symptoms.map(e => <li key={Math.random()}>{e}</li>)
                                    }
                                </ul>
                            </>
                        }

                        {
                            ...
                            <>
                                ...
                                <ul className="list-disc list-inside text-gray-500 sm:text-lg mb-6 md:mb-8">
                                    {
                                        risk.map(e => <li key={Math.random()}>{e}</li>)
                                    }
                                </ul>
                            </>
                        }

                        {
                            ...
                            <>
                                ...
                                <ul className="list-disc list-inside text-gray-500 sm:text-lg mb-6 md:mb-8">
                                    {
                                        treatment.map(e => <li key={Math.random()}>{e}</li>)
                                    }
                                </ul>
                            </>
                        }
