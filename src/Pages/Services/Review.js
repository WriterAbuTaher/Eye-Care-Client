        ...
        <>
            <section className="my-8 bg-gray-100 ">
                <div className="container flex flex-col items-center mx-auto md:p-12">
                    <h1 className="p-4 text-4xl font-semibold leading-none text-center">What Our Patience Are Saying About Us</h1>
                </div>
            ...
            <div className="flex flex-col w-full p-8 shadow-sm rounded-xl lg:p-12 bg-gray-100 ">
                <div className="flex flex-col items-center w-full">
                    ...
                    <button
                        className="group relative inline-block focus:outline-none focus:ring my-4"
                    >
                        <span
